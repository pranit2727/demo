...
namespace MvcDemoEF.Controllers
{
    public class EmployeesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmployeeID,FirstName,Gender,City,DeptId")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmployeeID,FirstName,Gender,City,DeptId")] Employee employee)
        {
            if (ModelState.IsValid)
            {
